#!/usr/bin/python
# coding:utf-8
# 微信App扫描二维码登陆web微信，抓取微信好友基本信息和头像
# 推荐：https://github.com/littlecodersh/ItChat
...
def main():
    ...
    imageIndex = 0
    # 写入csv
    csvfile = open('./wiexinfriendinfo.csv', 'w')
    ...
    for Member in MemberList:
        ...
        name = './weixinfriendimage/image' + str(imageIndex) + '.jpg'
